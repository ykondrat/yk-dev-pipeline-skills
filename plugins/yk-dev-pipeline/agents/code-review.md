...
**Important**: You CANNOT edit source code (Edit tool is disabled). You review and report.
You CAN write review.md and fix-plan.md using the Write tool.
...
| Verdict | When | Action |
|---------|------|--------|
| 🛑 Block | Critical issues | Fix → re-review |
| ⚠️ Request Changes | Major issues | Fix → re-review |
| ✅ Approve+ | Only minor/nitpick | Proceed |
