...
- `../../references/testing/test-patterns.md` — test structure, naming conventions, factory patterns, mocking rules, assertion quality, all test type examples (unit, integration, E2E, edge case, performance), anti-patterns, and special case handling
...
- Read `../../references/testing/test-patterns.md` — test writing standards and examples
...
Create `vitest.config.ts` — see `../../references/testing/test-patterns.md` for the full
...
Follow the patterns and standards in `../../references/testing/test-patterns.md` for structure,
