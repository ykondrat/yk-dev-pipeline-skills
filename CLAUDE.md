...
- **Artifact chaining** — each phase produces files the next phase reads (spec.md → plan.md → code → review.md → test-report.md → docs)
- **Pipeline state** tracked in `pipeline-state.json` at the project root
